  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20 md:pt-32 pb-20 bg-background">
      ...
      <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <SpotlightButton as={Link} href="/signin" className="bg-primary text-primary-foreground hover:bg-primary/90 border-transparent">
            Start Free Scan
          </SpotlightButton>
          <SpotlightButton as={Link} href="https://github.com/Buddhsen-tripathi/openvscan" className="hover:bg-muted/10">
            View on GitHub
          </SpotlightButton>
        </motion.div>
      </div>
