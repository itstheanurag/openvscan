      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-xl font-bold text-foreground">OpenVScan</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link
              href="/features"
              className="text-sm text-nav-text hover:text-nav-text-hover transition-colors"
            >
              Features
            </Link>
            <Link
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 space-y-4 border-t border-border">
            <Link
              href="/features"
              className="block text-nav-text hover:text-nav-text-hover transition-colors text-sm"
            ...
            <Link
              href="/get-started"
              className="block px-5 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors text-sm font-medium text-center"
              onClick={() => setIsMenuOpen(false)}
            >
              Get Started
            </Link>
