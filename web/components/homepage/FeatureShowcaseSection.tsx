...
import { Shield, Zap, Search, FileCode, CheckCircle2, AlertTriangle, Bug, GitBranch, Package, Loader2 } from 'lucide-react';
			...
			<div className="max-w-7xl mx-auto relative z-10">
				...
				>
					<h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4 tracking-tight">
						See It In
						<span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent-foreground"> Action</span>
					</h2>
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						Watch how our AI-powered security scanner analyzes your code in real-time and provides actionable insights.
					</p>
				</motion.div>
							...
							{scanningSteps.map((step, index) => (
								...
								>
									...
									<div className="flex-shrink-0">
										<step.icon className={cn("w-5 h-5", 
