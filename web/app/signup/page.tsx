...
export default function SignUpPage() {
  ...
  return (
    <section className="p-4 min-h-screen flex items-center justify-center bg-background relative overflow-hidden py-8">
      ...
      {/* Animated SVG Rings */}
      <div className="absolute inset-0 flex items-center justify-center blur-3xl pointer-events-none" style={{ opacity: 0.15 }}>
        <div className="w-[600px] h-[600px] bg-primary/20 rounded-full animate-pulse-slow" />
      </div>
      
      <div className="relative bg-background/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-border/50 w-full max-w-full sm:max-w-md px-8 sm:px-8 py-6 md:py-8 mx-auto text-center z-10 animate-fade-in-up overflow-y-auto"
           style={{ maxHeight: 'calc(100vh - 2rem)' }}
      >
        <div className="mb-6 flex items-center justify-center gap-2">
          <Image src="/logo.png" alt="Logo" width={36} height={36} className="rounded-lg shadow-lg shadow-primary/20" priority />
        ...
        <p className="mb-8 text-sm text-muted-foreground">Sign up to secure your code before it ships.</p>
